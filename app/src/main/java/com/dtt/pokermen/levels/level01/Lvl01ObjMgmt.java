...
public class Lvl01ObjMgmt {
	...
	public Lvl01ObjMgmt(Activity x){
		a = x;
		findViews();
		getScreenDims();
		getCords();
		update_town_txt();
		set_npc_locatoin_lvl_1();
		detect_protect = 0;
		event_id = 0;
	}

	public void ReInitializeLevelScreen(Activity activity){
		a = activity;
	...
	// Sets the NPC's location for lvl 1
		public void set_npc_locatoin_lvl_1(){	        
	        // doc
