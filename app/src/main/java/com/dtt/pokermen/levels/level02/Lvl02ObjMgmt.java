...
public class Lvl02ObjMgmt {
	...
	public Lvl02ObjMgmt(Activity x){
		a = x;
		findViews();
		getScreenDims();
		getCords();
		update_town_txt();
		set_npc_locatoin_lvl_2();
		detect_protect = 0;
		event_id = 0;
	}
	...
	// Sets the NPC's location for lvl 2
		public void set_npc_locatoin_lvl_2(){	        
	        // doc
		...
		public void update_town_txt(){
			town_txt.setText("2 - Hip Hop City");
		}
