 ...
 */
public class Lvl03 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl03);
    ...
    public void onResume() {
        super.onResume();
        MusicManagment.PlayMusic(this, MusicManagment.Songs.CrampForest);
    }
    ...
    public void initialize(){
        gameDat.set_game_lvl(3);
        obs = new Lvl03ObjMgmt(this);
    ...
    public void eventHandle(){
        ...
        if(id == 4){
            ...
            finish();
            Log.i("DTT","Going from LVL3 to LVL4...");
        }
        if(id == 5){
            ...
            startActivity(change_lvl);
            finish();
            Log.i("DTT","Going from LVL3 to LVL2...");
        }
