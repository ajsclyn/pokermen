package com.dtt.pokermen.levels.level04;
...
import com.dtt.pokermen.levels.level05.Lvl05;
...
public class Lvl04 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl04);
    ...
    public void onResume() {
        super.onResume();
        MusicManagment.PlayMusic(this, MusicManagment.Songs.DongCave);
    }
    ...
    public void initialize(){
        gameDat.set_game_lvl(4);
        obs = new Lvl04ObjMgmt(this);
    ...
    public void eventHandle(){
        ...
        if(id == 4) {
            Intent change_lvl = new Intent(this, Lvl05.class);
            startActivity(change_lvl);
            finish();
            Log.i("DTT", "Going from LVL4 to LVL5...");
        }
        if(id == 5){
            ...
            startActivity(change_lvl);
            finish();
            Log.i("DTT","Going from LVL4 to LVL3...");
        }
