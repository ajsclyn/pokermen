...
public class Lvl04ObjMgmt {
    ...
    public Lvl04ObjMgmt(Activity x){
        a = x;
        findViews();
        getScreenDims();
        getCords();
        update_town_txt();
        set_npc_locatoin_lvl_4();
        detect_protect = 0;
        event_id = 0;
    }
    ...
    // listener for trainer 01 (in LVL 4)
    ...
    // Sets the NPC's location for lvl 4
    public void set_npc_locatoin_lvl_4(){
        // doc
