package com.dtt.pokermen.levels.level05;
...
public class Lvl05 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lvl05);
    ...
    public void onResume() {
        super.onResume();
        MusicManagment.PlayMusic(this, MusicManagment.Songs.Nutterville);
    }
    ...
    public void eventHandle(){
        ...
        if(id == 5){
            Intent change_lvl = new Intent(this,Lvl04.class);
            change_lvl.putExtra("dir", 1);
            startActivity(change_lvl);
            finish();
            Log.i("DTT","Going from LVL5 to LVL4...");
        }
