...
/**
 * Created by Zachary on 2/10/2015.
 */
public class Lvl05ObjMgmt {
    Activity a;
    ...
    public Lvl05ObjMgmt(Activity x){
        a = x;
        findViews();
        getScreenDims();
        getCords();
        update_town_txt();
        set_npc_locatoin_lvl_5();
        detect_protect = 0;
        event_id = 0;
    }
    ...
    // listener for trainer 01 (in LVL 5)
    ...
    // Sets the NPC's location for lvl 5
    public void set_npc_locatoin_lvl_5(){
        // doc
    ...
    public void update_town_txt(){
        town_txt.setText("5 - Nutterville");
    }
